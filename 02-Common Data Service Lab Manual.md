...
### Task 2: Explore standard option sets
Just like standard entities, the Common Data Service includes a set of standard Option Sets. You can also create customOption Sets. Later in this lab, we will create a custom Option Set called ApprovalStatus to set the approval status of a device order.</br>
...
2. Enter Price for Display Name, select Currency for Data Type, make the field Required andSearchable and click Advanced Options.</br>
